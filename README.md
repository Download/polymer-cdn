# polymer-cdn <sup><sub>v1.6.0</sub></sup>
...
```
https://cdn.rawgit.com/download/polymer-cdn/1.6.0/lib/my-cool-element/my-cool-element.html
```
...
## Contents
All the libraries available in polymer-cdn can be found side-by-side in the [lib](https://github.com/Download/polymer-cdn/tree/1.6.0/lib) subfolder.
...
```sh
polymer-cdn#1.6.0
├─┬ app-elements#0.9.0 (latest is 0.10.0)
│ ├─┬ app-layout#0.9.2 (latest is 0.10.4)
│ │ ├─┬ iron-flex-layout#1.3.1
│ │ │ └── polymer#1.6.0 (1.6.1 available)
